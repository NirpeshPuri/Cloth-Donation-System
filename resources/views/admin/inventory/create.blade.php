    ...
    <div class="container mx-auto px-6 py-8">
        <div class="gradient-bg rounded-2xl p-8 text-white mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Add New Cloth to Inventory</h1>
                    <p class="text-teal-100">Add a new clothing item to your collection center</p>
                </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="category"
                                    ...
                                    <option value="Shirt" {{ old('category') == 'Shirt' ? 'selected' : '' }}>👕 Shirt
                                    </option>
                                    <option value="T-Shirt" {{ old('category') == 'T-Shirt' ? 'selected' : '' }}>👕 T-Shirt
                                    </option>
                                    <option value="Jeans" {{ old('category') == 'Jeans' ? 'selected' : '' }}>👖 Jeans
                                    </option>
                                    <option value="Pants" {{ old('category') == 'Pants' ? 'selected' : '' }}>👖 Pants
                                    </option>
                                    <option value="Jacket" {{ old('category') == 'Jacket' ? 'selected' : '' }}>🧥 Jacket
                                    </option>
                                    <option value="Sweater" {{ old('category') == 'Sweater' ? 'selected' : '' }}>🧥 Sweater
                                    </option>
                                    <option value="Dress" {{ old('category') == 'Dress' ? 'selected' : '' }}>👗 Dress
                                    </option>
                                    <option value="Saree" {{ old('category') == 'Saree' ? 'selected' : '' }}>👘 Saree
                                    </option>
                                    <option value="Kurta" {{ old('category') == 'Kurta' ? 'selected' : '' }}>👘 Kurta
                                    </option>
                            ...
                            <div>
                                ...
                                <select name="quality"
                                    ...
                                    <option value="new" {{ old('quality') == 'new' ? 'selected' : '' }}>✨ New (With
                                        tags)</option>
                                    <option value="like_new" {{ old('quality') == 'like_new' ? 'selected' : '' }}>👍 Like
                                        New</option>
                                    <option value="good" {{ old('quality') == 'good' ? 'selected' : '' }}>✅ Good
                                    </option>
                                    <option value="fair" {{ old('quality') == 'fair' ? 'selected' : '' }}>⚠️ Fair
                                    </option>
                                </select>
                                @error('quality')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="3"
                                    class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="bg-teal-50 rounded-xl p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-2">
                            ...
                            <span class="text-sm">Add clothes donated by users or from your collection center</span>
                        </li>
                        <li class="flex items-start gap-2">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <span class="text-sm">Add images to help receivers identify items</span>
                        </li>
                        <li class="flex items-start gap-2">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if (isset($cloth) && $cloth->donor_id)
                const existingDonorId = {{ $cloth->donor_id }};
                if (existingDonorId) {
                    fetchDonorDetails(existingDonorId);
                    const donorOption = new Option('', existingDonorId, true, true);
